...
<template>
    <nav class="bg-white py-3 border-b border-gray-100 h-[6rem]">
    ...
    <div class="min-h-screen flex sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100" style="min-height: calc(100vh - 6rem);">
        <!-- <div>
            <Link href="/">
